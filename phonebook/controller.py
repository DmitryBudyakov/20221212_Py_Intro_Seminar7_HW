...
def phonebook_run():
    while True:
        ...
        if selector == '1':     # поиск контакта
            ...
            print()
            input(msg_back_top_menu)
        elif selector == '4':   # удаление контакта
            view.cls_show_app_head()
...
sub_menu_del_contact = '4. Удалить контакт\n'
sub_menu_export_book = '5. Экспорт контактов\n'
